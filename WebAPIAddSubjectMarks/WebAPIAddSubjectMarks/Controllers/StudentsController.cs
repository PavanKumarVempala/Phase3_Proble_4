...
using WebAPIAddSubjectMarks.Models;

namespace WebAPIAddSubjectMarks.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public StudentsController(School_ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Student>> PostStudent(Student student)
        {
          if (_context.Students == null)
          {
              return Problem("Entity set 'School_ProjectContext.Students'  is null.");
          }
